 ...
 * @since 28.04.2021
 */
public class UnirestConfigurationTest {
    private static final Logger logger = LoggerFactory.getLogger(UnirestConfigurationTest.class);

    private Integer connectionTimeout = 60000*3;
    private Integer connectionRequestTimeout = 60000*3;
    private Integer socketTimeout = 60000*3;

    public UnirestConfigurationTest() {
