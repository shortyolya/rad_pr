...
public class CianIndustryConverter extends CianRealEstateConverter implements CianConverter<VCianRealEstate> {
    ...
    public CianIndustryConverter(FeedDescriptionService feedDescriptionService) {
