...
public class CianWarehouseConverter extends CianRealEstateConverter implements CianConverter<VCianRealEstate> {
    ...
    public CianWarehouseConverter(FeedDescriptionService feedDescriptionService) {
