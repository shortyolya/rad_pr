 ...
 * @since 21.03.2023
 */
public class CianRoomConverter extends CianFlatConverter {
    ...
    private static final List<Pair<VCianRealEstateParams, Boolean>> params =
            new ArrayList<Pair<VCianRealEstateParams, Boolean>>() {{
                ...
                add(new Pair(VCianRealEstateParams.ROOM_AREA, true));
    ...
    public CianRoomConverter(FeedDescriptionService feedDescriptionService) {
    ...
    public Object makeObject(VCianRealEstate cianObj) {
        ...
        obj.setRoomArea(Double.valueOf(cianObj.getRoomArea()));
        return obj;
    }
