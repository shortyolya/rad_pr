 ...
 * @since 23.09.2020
 */
public class AvitoJewelryConverter extends VAvitoMovableConverter implements AvitoConverter<VAvitoMovable> {
    ...
    public AvitoJewelryConverter(FeedDescriptionService feedDescriptionService) {
    ...
    public Ad makeAd(VAvitoMovable avitoObj, Long mevUnid) {
        ...
        ad.setGoodsType("Ювелирные изделия");
        ad.setCondition("Б/у");
