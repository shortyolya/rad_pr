...
public class CianFreeAppointmentObjectConverter extends CianRealEstateConverter implements CianConverter<VCianRealEstate> {
    ...
    public CianFreeAppointmentObjectConverter(FeedDescriptionService feedDescriptionService) {
