...
public class CianBusinessConverter extends CianRealEstateConverter implements CianConverter<VCianRealEstate> {
    ...
    public CianBusinessConverter(FeedDescriptionService feedDescriptionService) {
