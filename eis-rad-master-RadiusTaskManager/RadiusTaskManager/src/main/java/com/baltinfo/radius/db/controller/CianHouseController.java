 ...
 * @since 24.03.2023
 */
public class CianHouseController extends AbstractController implements CianController<VCianRealEstate> {
    private static final Logger logger = LoggerFactory.getLogger(CianHouseController.class);
