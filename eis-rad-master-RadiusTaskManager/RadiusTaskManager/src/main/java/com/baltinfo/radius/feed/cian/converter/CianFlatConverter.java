...
import com.baltinfo.radius.feed.cian.model.CianSaleType;
 ...
 * @since 21.03.2023
 */
public class CianFlatConverter extends CianRealEstateConverter implements CianConverter<VCianRealEstate> {
    ...
    public CianFlatConverter(FeedDescriptionService feedDescriptionService) {
    ...
    public BargainTerms makeBargainTerms(VCianRealEstate cianObj) {
        ...
        bargainTerms.setSaleType(CianSaleType.FREE.getCode());
        return bargainTerms;
    }
