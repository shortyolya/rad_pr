 ...
 * @since 21.09.2020
 */
public class AvitoWaterTransportConverter extends VAvitoMovableConverter implements AvitoConverter<VAvitoMovable> {
    ...
    private static final List<Pair<VAvitoMovableParams, Boolean>> params = new ArrayList<Pair<VAvitoMovableParams, Boolean>>() {{
        ...
        add(new Pair(VAvitoMovableParams.PRICE, false));
    }};

    public AvitoWaterTransportConverter(FeedDescriptionService feedDescriptionService) {
    ...
    public Ad makeAd(VAvitoMovable avitoObj, Long mevUnid) {
        ...
        ad.setVehicleType("Моторные лодки");
        ad.setCondition("Б/у");
