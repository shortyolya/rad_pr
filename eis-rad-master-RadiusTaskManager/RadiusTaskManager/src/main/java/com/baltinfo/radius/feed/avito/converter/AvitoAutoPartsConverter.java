 ...
 * @since 23.09.2020
 */
public class AvitoAutoPartsConverter extends VAvitoMovableConverter implements AvitoConverter<VAvitoMovable> {
    ...
    public AvitoAutoPartsConverter(FeedDescriptionService feedDescriptionService) {
