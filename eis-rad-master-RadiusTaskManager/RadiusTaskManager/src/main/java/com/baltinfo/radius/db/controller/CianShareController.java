 ...
 * @since 24.03.2023
 */
public class CianShareController extends AbstractController implements CianController<VCianRealEstate> {
    private static final Logger logger = LoggerFactory.getLogger(CianShareController.class);
