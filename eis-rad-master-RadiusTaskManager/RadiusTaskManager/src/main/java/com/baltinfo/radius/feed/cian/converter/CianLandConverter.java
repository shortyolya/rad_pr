 ...
 * @since 22.03.2023
 */
public class CianLandConverter extends CianRealEstateConverter implements CianConverter<VCianRealEstate> {
    ...
    public CianLandConverter(FeedDescriptionService feedDescriptionService) {
