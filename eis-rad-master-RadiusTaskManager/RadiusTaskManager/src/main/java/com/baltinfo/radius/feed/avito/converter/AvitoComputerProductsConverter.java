 ...
 * @since 23.09.2020
 */
public class AvitoComputerProductsConverter extends VAvitoMovableConverter implements AvitoConverter<VAvitoMovable> {
    ...
    public AvitoComputerProductsConverter(FeedDescriptionService feedDescriptionService) {
