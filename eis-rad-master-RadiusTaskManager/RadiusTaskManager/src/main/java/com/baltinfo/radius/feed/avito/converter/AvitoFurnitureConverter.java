...
public class AvitoFurnitureConverter extends VAvitoMovableConverter implements AvitoConverter<VAvitoMovable> {
    ...
    public AvitoFurnitureConverter(FeedDescriptionService feedDescriptionService) {
    ...
    public Ad makeAd(VAvitoMovable avitoObj, Long mevUnid) {
        ...
        ad.setGoodsType("Предметы интерьера, искусство");
        ad.setCondition("Б/у");
