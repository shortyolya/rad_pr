...
public class HikariConnectionProvider implements ConnectionProvider, Configurable, Stoppable {
    ...
    @Override
    public void stop() {
        LOGGER.info("********************************* " + getPoolName() + " Stops *********************************");
        this.hds.close();

        LOGGER.info("********************************* " + getPoolName() + " Stoped *********************************");
    }

    public String getPoolName() {
        return hds.getPoolName() + " for " + hcfg.getDataSourceProperties().getProperty("user") + " on " + hcfg.getDataSourceProperties().getProperty("serverName");
    }
}
