...
public class CianShoppingAreaConverter extends CianRealEstateConverter implements CianConverter<VCianRealEstate> {
    ...
    public CianShoppingAreaConverter(FeedDescriptionService feedDescriptionService) {
