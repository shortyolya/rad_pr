...
public class CianBuildingConverter extends CianRealEstateConverter implements CianConverter<VCianRealEstate> {
    ...
    public CianBuildingConverter(FeedDescriptionService feedDescriptionService) {
    ...
    private Building makeBuilding(VCianRealEstate cianObj) {
        ...
        building.setTotalArea(cianObj.getTotalArea());
        return building;
    }
}
