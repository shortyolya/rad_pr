...
import com.baltinfo.radius.feed.cian.model.Garage;
...
public class CianGarageConverter extends CianRealEstateConverter implements CianConverter<VCianRealEstate> {
    ...
    private static final List<Pair<VCianRealEstateParams, Boolean>> params =
            new ArrayList<Pair<VCianRealEstateParams, Boolean>>() {{
                ...
                add(new Pair(VCianRealEstateParams.GARAGE_TYPE, true));
    ...
    public CianGarageConverter(FeedDescriptionService feedDescriptionService) {
    ...
    public Object makeObject(VCianRealEstate cianObj) {
        ...
        obj.setGarage(makeGarage(cianObj));
    ...
    private Garage makeGarage(VCianRealEstate cianObj) {
        Garage garage = new Garage();
        garage.setType(cianObj.getGarageType());
        return garage;
    }
}
